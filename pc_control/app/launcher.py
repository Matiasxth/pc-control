...
_APPS = {
    ...
    "firefox": {
        "cmd": "start firefox",
        "with_arg": 'start firefox "{arg}"',
        "desc": "Mozilla Firefox",
    },
    "spotify": {
        "cmd": "start spotify:",
        "with_arg": "start spotify:search:{arg}",
        "desc": "Spotify",
    },
    ...
    "settings": {
        ...
        "with_arg": "start ms-settings:{arg}",
        "desc": "Windows Settings",
    },
    ...
    if key not in _APPS:
        ...
        try:
            ...
            _output(
                {
                    "status": "error",
                    "error": f"Unknown app: {name}. Use 'app list' to see available apps.",
                }
            )
            return
...
def list_apps():
    ...
    apps = [
        {"name": k, "description": v["desc"], "supports_arg": "with_arg" in v}
